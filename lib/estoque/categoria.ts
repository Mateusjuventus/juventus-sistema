...
/** Confere se o parâmetro da URL (params.categoria) é uma ramificação válida do Estoque —
 * "esportivo", "medico" (Medicamentos) ou "materiais". Usado em toda página/rota que recebe esse
 * parâmetro, pra rejeitar qualquer outro valor com notFound()/404. */
