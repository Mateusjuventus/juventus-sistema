...
describe("montarAssinaturasDispensa", () => {
  it("mapeia cada papel salvo pro campo certo, ignorando papéis desconhecidos", () => {
    const resultado = montarAssinaturasDispensa([
      {
        papel: "treinador",
        nomeNoMomento: "Fabinho",
        cargoNoMomento: "Treinador Sub15",
        assinadoEm: "2026-08-28T10:00:00Z",
        assinaturaImagemSrc: "https://example.com/assinatura-fabinho.png",
      },
      {
        papel: "departamento",
    ...
    expect(resultado.treinador).toEqual({
      nome: "Fabinho",
      cargo: "Treinador Sub15",
      assinadoEm: "2026-08-28T10:00:00Z",
      assinaturaImagemSrc: "https://example.com/assinatura-fabinho.png",
    });
