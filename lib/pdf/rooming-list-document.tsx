...
const styles = StyleSheet.create({
  ...
  colApartamento: { width: 44, borderRightWidth: 0.5, borderRightColor: "#c7c7c7" },
  colNome: { width: 195 },
  colNascimento: { width: 54 },
  colCpf: { width: 72 },
  colRg: { width: 78 },
  grupoQuarto: {
    borderTopWidth: 0.5,
  ...
  colNomeCorpo: { width: 195 },
  colNascimentoCorpo: { width: 54 },
  colCpfCorpo: { width: 72 },
  colRgCorpo: { width: 78 },
