...
/**
 * Server actions da Logística de Jogo (rooming list, ônibus e credenciamento por zona).
 * Ver docs/superpowers/specs/2026-07-09-convocacao-presskit-logistica-design.md.
 */

function revalidateLogistica(jogoId: string) {
  revalidatePath(`/jogos/${jogoId}/logistica`);
}
