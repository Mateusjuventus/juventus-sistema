...
/**
 * Uma seção (Atletas ou Comissão Técnica) da Lista de Ônibus: quem foi convocado já aparece na
 * lista, marcado como "vai de ônibus" por padrão (dá pra desmarcar quem não vai); um seletor no
 * fim deixa adicionar alguém que não foi convocado (some da lista de "disponíveis" assim que
 * adicionado, e pode ser removido de novo).
 */
