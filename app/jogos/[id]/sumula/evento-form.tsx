...
/**
 * Formulário de adicionar um evento (gol, cartão, substituição) num tempo específico — cada evento
 * salva imediatamente ao clicar "Adicionar evento" (sem lote, ver a spec). Reaproveita o mesmo
 * campo "atletaId" pra quem fez o gol / recebeu o cartão / saiu (substituição), já que a coluna no
 * banco é a mesma (`sumula_eventos.atleta_id`) nos quatro tipos.
 */
