...
import { createCarga } from "../../actions";

export default async function NovaCargaPage({ params }: { params: { id: string } }) {
  ...
  return (
    <AppShell>
      ...
      <h1 className="mt-2 text-2xl font-bold text-grena-escuro">Nova carga</h1>
      <div className="mt-4">
        <CargaForm action={createCarga} jogoId={jogo.id} submitLabel="Cadastrar" />
      </div>
    </AppShell>
  );
}
