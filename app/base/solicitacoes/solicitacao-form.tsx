 ...
 * salvarItensInlineBase em ./actions.ts), com um campo de Valor somado automaticamente no total.
 */
...
export function SolicitacaoForm({
   ...
   * da conta de quem está logado (ver `createSolicitacaoBase`/`updateSolicitacaoBase`), então nem
   * precisa ir junto no FormData daqui; só Master continua com o campo de texto livre de sempre. */
