...
import type { StaffOperacionalBaseComFuncaoRow } from "@/lib/supabase/types";
...
/** Exporta a lista de Staff Operacional (Futebol de Base) pra Excel — espelha
 * `app/staff-operacional/export/route.ts`. */
export async function GET(request: NextRequest) {
  ...
  return buildXlsxResponse("staff-operacional-base.xlsx", [{ nome: "Staff Operacional (Base)", linhas }]);
}
