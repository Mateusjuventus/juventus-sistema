 ...
 * — ver salvarItensInline em ./actions.ts. A caixa de ida/volta fica sempre no DOM (só escondida
 * via CSS quando "Não"), pra não desalinhar os índices dos campos entre linhas na hora de ler
 * `formData.getAll(...)` no servidor.
 */
