...
/** Ramificações de Estoque (Esportivo/Medicamentos/Materiais) liberadas pra esse usuário — ver
...
/** Salva quais ramificações de Estoque (Esportivo/Medicamentos/Materiais) um usuário "regular" já existente pode
