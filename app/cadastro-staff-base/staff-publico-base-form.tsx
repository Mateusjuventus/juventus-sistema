...
import type { CadastroPublicoBaseFormState } from "./actions";

const initialState: CadastroPublicoBaseFormState = {};

/** Espelha `app/cadastro-staff/staff-publico-form.tsx`. */
export function StaffPublicoBaseForm({
  action,
  funcoes,
}: {
  action: (
    prevState: CadastroPublicoBaseFormState,
    formData: FormData,
